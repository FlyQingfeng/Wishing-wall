<template>
    <div class="card">
        <section class="container">
            <div class="heading">
                <img class="heading_img"
                    src="./icons/wish.png">
                <h1 class="heading_title">许个愿吧</h1>
            </div>
            <form class="form">
                <div>
                    <label class="form_label" for="todo">~ 写下你的愿望吧 ~</label>
                    <textarea class="form_input" v-model="value" cols="30" rows="15"></textarea>
                    <!-- <input class="form_input" type="text" id="todo" name="to-do" size="30" required> -->
                    <button class="button" @click="confirmWish"><span>许愿</span></button>
                </div>
            </form>
            <!-- <div>
